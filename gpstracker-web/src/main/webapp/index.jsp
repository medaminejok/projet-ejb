				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 page-header">
							<h2 class="page-title" style="font-size: 20px;color: with">Statistiques</h2><br><br>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="card">
									<div class="content">
										<div class="head">
											<h5 class="mb-0">Véhicules par kilométrage</h5>
							...
							<div class="col-md-6">
								<div class="card">
									<div class="content">
										<div class="head">
											<h5 class="mb-0">Géolocalisation des vehicule</h5>
											<p class="text-muted"></p>
										</div>
										<div class="canvas-wrapper">
